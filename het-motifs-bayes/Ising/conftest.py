...
mock_rt_graph_edge_list = [
    ...
    {"user_screen_name": "A", "retweet_user_screen_name": "B", "retweet_count": 25},
    {"user_screen_name": "A", "retweet_user_screen_name": "F", "retweet_count": 20},
    {"user_screen_name": "B", "retweet_user_screen_name": "D", "retweet_count": 20},
    {"user_screen_name": "B", "retweet_user_screen_name": "A", "retweet_count": 20},
    {"user_screen_name": "C", "retweet_user_screen_name": "B", "retweet_count": 20},
    # add some examples of users retweeting eachother:
    {"user_screen_name": "C", "retweet_user_screen_name": "D", "retweet_count": 23},
    {"user_screen_name": "E", "retweet_user_screen_name": "F", "retweet_count": 10},
    {"user_screen_name": "E", "retweet_user_screen_name": "D", "retweet_count": 20},
    {"user_screen_name": "E", "retweet_user_screen_name": "H", "retweet_count": 10},
    {"user_screen_name": "E", "retweet_user_screen_name": "F", "retweet_count": 10},
    {"user_screen_name": "F", "retweet_user_screen_name": "D", "retweet_count": 25},
    {"user_screen_name": "F", "retweet_user_screen_name": "A", "retweet_count": 18},
    {"user_screen_name": "G", "retweet_user_screen_name": "D", "retweet_count": 22},
    {"user_screen_name": "G", "retweet_user_screen_name": "A", "retweet_count": 10},
    {"user_screen_name": "H", "retweet_user_screen_name": "E", "retweet_count": 8},
    {"user_screen_name": "H", "retweet_user_screen_name": "F", "retweet_count": 25},
...
wet={}
for i in lst:
    wet[str(i[0])+'->'+str(i[1])]=lst.count(i)
print(wet)
mock_rt_graph_edge_list=[]
for i in wet.keys():
    loc=i.find('-')
    mock_rt_graph_edge_list.append({"user_screen_name": i[:loc], "retweet_user_screen_name": i[loc+2:], "retweet_count":wet[i]})
'''
import networkx as nx
import matplotlib.pyplot as plt
...
for i in net:
    mock_rt_graph_edge_list.append({"user_screen_name": i[0], "retweet_user_screen_name": i[1], "retweet_count":i[2]})
...
def compile_mock_rt_graph(edge_list=mock_rt_graph_edge_list, weight_attr="retweet_count"):
    ...
    graph = nx.DiGraph()   #根据自己的网络可进行修改，原版本为有向网络
